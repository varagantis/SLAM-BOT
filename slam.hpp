...
public:
    ...
    * \param    localizationUnknownMode     Flag indicating if we will run the sensor model when updating the particle filter
    ...
    */
    OccupancyGridSLAM(int numParticles, 
                      ...
                      bool convergeOnlyMode = false,
                      const std::string escapeMap = std::string(""),
...
private:
    ...
    pose_xyt_t initialEscapePose_;
    pose_xyt_t previousEscapePose_;
    pose_xyt_t currentEscapePose_;
    
    ParticleFilter filter_;
    ParticleFilter escape_filter_;
    OccupancyGrid map_;
    OccupancyGrid escape_map_;
    Mapping mapper_;
    particles_converged_t converged_;
